...
import id.pptik.bawaslubatch.models.Pojo;
...
class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class MenuItemViewHolder extends RecyclerView.ViewHolder {
        ...
        MenuItemViewHolder(View view) {
            super(view);
//            menuItemImage = (ImageView) view.findViewById(R.id.);
            menuItemName = (TextView) view.findViewById(R.id.card_tgl);
            menuItemPrice = (TextView) view.findViewById(R.id.card_comment);
            menuItemCategory = (TextView) view.findViewById(R.id.card_tlp);
         ...
         /*   case NATIVE_EXPRESS_AD_VIEW_TYPE:
            ...
            default:
                View menuItemLayoutView = LayoutInflater.from(viewGroup.getContext()).inflate(
                        R.layout.cardview_post, viewGroup, false);
